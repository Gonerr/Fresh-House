...
// Функция для изменения состояния кнопки смены темы
...
//проверяем предыдущую сохраненную тему
...
function changeColorScheme() {
    ...
    var secondText = document.querySelectorAll(".second-text");
    ...
    if (gameContainer.classList.contains("dark-mode")) {
      ...
      secondText.forEach(function(text) {
     ...
     // console.log('тута',ChangeColor);
       ...
       if (helpButtonClicked){
        document.querySelector(".second-text.help").style.color = "black";
        document.querySelector(".second-text.help").style.backgroundColor = "white";
      }
    localStorage.setItem("colorScheme", "light");
      ...
      if (document.querySelector(".name-of-game")){document.getElementById("query_user").classList.add("dark-mode");
     ...
     // console.log('тута',ChangeColor);
      ...
      if (helpButtonClicked){
        document.querySelector(".second-text.help").style.color = "white";
        document.querySelector(".second-text.help").style.backgroundColor = "#22212b";
      }
    }
